    ...
    <div class="text-input-section">
      <div class="input-header">
        ...
        <div class="input-actions">
          ...
          <button @click="pasteFromClipboard" class="action-btn" :title="$t('common.paste')" aria-label="按钮">
            <Clipboard :size="14" />
          </button>
        </div>
      </div>
