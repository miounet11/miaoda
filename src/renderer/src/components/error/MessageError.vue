<template>
  <div class="message-error">
    ...
    <div class="error-actions">
      <button v-if="showRetry" @click="$emit('retry')" class="retry-button" :disabled="retrying" aria-label="按钮">
        <RefreshCw :size="14" :class="{ 'animate-spin': retrying }" />
        {{ retrying ? $t('common.retrying') : $t('common.retry') }}
      </button>

      <button @click="showDetails = !showDetails" class="details-button" aria-label="按钮">
