  ...
  <div class="search-result-item" :class="{ 'semantic-result': isSemanticResult }">
    ...
    <div class="result-header">
      ...
      <div class="result-actions">
        ...
        <button @click="findSimilar" class="action-btn similar-btn" title="Find Similar Messages" aria-label="按钮">
          <Search :size="14" />
        </button>

        <button @click="copyContent" class="action-btn copy-btn" title="Copy Content" aria-label="按钮">
          <Copy :size="14" />
        </button>

        <button @click="goToMessage" class="action-btn goto-btn" title="Go to Message" aria-label="按钮">
