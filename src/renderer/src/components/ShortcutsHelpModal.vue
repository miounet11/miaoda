<template>
  <div
    ...
    class="fixed inset-0 z-modal-backdrop flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm"
    @click.self="closeShortcutsHelp"
  >
    <div
      class="bg-white dark:bg-gray-800 rounded-lg shadow-xl modal max-w-2xl w-full mx-4 max-h-[80vh] overflow-y-auto"
    >
      <!-- Header -->
      <div
