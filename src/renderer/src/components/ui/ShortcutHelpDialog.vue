      ...
      <div class="overflow-y-auto max-h-[60vh]">
        <div class="p-6">
          ...
          <div class="mt-8 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
            <h4 class="text-sm font-medium text-blue-900 dark:text-blue-300 mb-2">Tips</h4>
            <ul class="text-sm text-blue-800 dark:text-blue-300 space-y-1">
              ...
              <li>
                • Press
                <kbd class="px-1 py-0.5 text-xs bg-blue-200 dark:bg-blue-800 rounded">Esc</kbd> to
