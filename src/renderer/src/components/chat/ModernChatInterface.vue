<template>
  <div class="modern-chat-container">
    <!-- 侧边栏 -->
    <aside
      :class="['modern-sidebar', { collapsed: sidebarCollapsed, open: sidebarOpen && isMobile }]"
    >
      <!-- 侧边栏头部 -->
      ...
      <div class="modern-chat-list">
        <div
          ...
          :key="chat.id"
          :class="['modern-chat-item', { active: currentChatId === chat.id }]"
      ...
      <header class="modern-chat-header">
        <div class="modern-header-left">
          ...
          <div class="modern-chat-title-wrapper">
            ...
            <div v-if="isLoading" class="modern-chat-subtitle">AI 正在思考...</div>
      ...
      <div class="modern-input-area">
        <div class="modern-input-container">
          ...
          <div class="flex items-center justify-between text-xs text-muted-foreground mt-2 px-1">
            ...
            <span v-if="inputCharacterCount > 0"> {{ inputCharacterCount }}/4000 </span>
          </div>
        </div>
      </div>
    </main>
