    ...
    <div class="config-content flex-1 overflow-y-auto pr-2 space-y-6">
        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center gap-2">
            <svg
              ...
              stroke-linecap="round"
              stroke-linejoin="round"
              class="lucide lucide-code text-gray-500"
              aria-hidden="true"
            >
          ...
          <div class="semi-switch semi-switch-small">
            <input
              ...
              @change="
                updateConfig('customRequestMode', ($event.target as HTMLInputElement).checked)
              "
            />
          </div>
        </div>
      ...
      <div class="config-section">
        <div class="flex items-center gap-2 mb-2">
          <svg
            ...
            stroke-linecap="round"
            stroke-linejoin="round"
            class="lucide lucide-users text-gray-500"
            aria-hidden="true"
          >
      ...
      <div class="config-section">
        <div class="flex items-center gap-2 mb-2">
          <svg
            ...
            stroke-linecap="round"
            stroke-linejoin="round"
            class="lucide lucide-sparkles text-gray-500"
            aria-hidden="true"
          >
            <path
      ...
      <div class="config-section">
        <div class="flex items-center justify-between mb-2">
          <div class="flex items-center gap-2">
            <svg
              ...
              stroke-linecap="round"
              stroke-linejoin="round"
              class="lucide lucide-image text-gray-400"
              aria-hidden="true"
            >
        ...
        <div v-if="config.imageUrls.length > 0" class="space-y-2 max-h-32 overflow-y-auto">
          <div
            v-for="(url, index) in config.imageUrls"
            :key="index"
      ...
      <div class="config-section">
        <div class="flex items-center justify-between mb-2">
          <div class="flex items-center gap-2">
            <svg
              ...
              stroke-linecap="round"
              stroke-linejoin="round"
              class="lucide lucide-thermometer text-gray-500"
              aria-hidden="true"
            >
          ...
          <button
            @click="resetParameter('temperature')"
        ...
        <input
          ...
          @input="
            updateConfig('temperature', parseFloat(($event.target as HTMLInputElement).value))
          "
          class="w-full"
        />
      </div>
      ...
      <div class="config-section">
        <div class="flex items-center justify-between mb-2">
          <div class="flex items-center gap-2">
            <svg
              ...
              stroke-linecap="round"
              stroke-linejoin="round"
              class="lucide lucide-repeat text-gray-500"
              aria-hidden="true"
            >
          ...
          <button
            @click="resetParameter('frequencyPenalty')"
            class="text-xs px-2 py-1 bg-green-100 text-green-700 rounded hover:bg-green-200"
          >
            ✓
          </button>
        ...
        <input
          ...
          @input="
            updateConfig('frequencyPenalty', parseFloat(($event.target as HTMLInputElement).value))
          "
          class="w-full"
        />
      </div>
      ...
      <div class="config-section">
        <div class="flex items-center justify-between mb-2">
          <div class="flex items-center gap-2">
            <svg
              ...
              stroke-linecap="round"
              stroke-linejoin="round"
              class="lucide lucide-ban text-gray-500"
              aria-hidden="true"
            >
              <circle cx="12" cy="12" r="10"></circle>
          ...
          <button
            @click="resetParameter('presencePenalty')"
            class="text-xs px-2 py-1 bg-green-100 text-green-700 rounded hover:bg-green-200"
          >
            ✓
          </button>
        ...
        <input
          ...
          @input="
            updateConfig('presencePenalty', parseFloat(($event.target as HTMLInputElement).value))
          "
          class="w-full"
        />
      </div>
      ...
      <div class="config-section">
        <div class="flex items-center justify-between mb-2">
          <div class="flex items-center gap-2">
            <svg
              ...
              stroke-linecap="round"
              stroke-linejoin="round"
              class="lucide lucide-hash text-gray-500"
              aria-hidden="true"
            >
          ...
          <button
            @click="resetParameter('maxTokens')"
        ...
        <input
          ...
          @input="
            updateConfig('maxTokens', parseInt(($event.target as HTMLInputElement).value) || 4096)
          "
          type="number"
          placeholder="4096"
        ...
        <div class="flex items-center justify-between mb-2">
          <div class="flex items-center gap-2">
            <svg
              ...
              stroke-linecap="round"
              stroke-linejoin="round"
              class="lucide lucide-shuffle text-gray-500"
              aria-hidden="true"
            >
        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center gap-2">
            <svg
              ...
              stroke-linecap="round"
              stroke-linejoin="round"
              class="lucide lucide-toggle-left text-gray-500"
              aria-hidden="true"
            >
