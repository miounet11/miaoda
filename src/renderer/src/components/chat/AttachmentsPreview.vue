      ...
      <div class="flex flex-wrap gap-3">
        ...
        >
          ...
          <div v-else-if="attachment.type === 'video'" class="video-attachment relative">
            ...
            >
              <button @click.stop="openFilePreview(attachment)" class="action-btn" title="预览" aria-label="按钮">
                <Play :size="12" />
              </button>
              <button @click.stop="downloadFile(attachment)" class="action-btn" title="下载" aria-label="按钮">
                <Download :size="12" />
              </button>
              <button
                @click.stop="$emit('remove', attachment.id)"
