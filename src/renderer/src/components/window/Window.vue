  ...
  <div class="window" :class="windowClasses">
    ...
    <div v-if="showHeader" class="window-header" @dblclick="toggleMaximize">
      ...
      <div class="window-controls">
        ...
        <button @click="closeWindow" class="control-btn close-btn" :title="t('window.close')" aria-label="按钮">
          <X :size="12" />
        </button>
      </div>
      ...
      <div class="window-actions">
        <button @click="openSettings" class="settings-btn" :title="t('common.settings')" aria-label="按钮">
          <Settings :size="16" />
        </button>
        <button @click="showWindowMenu" class="window-menu-btn" :title="t('window.menu')" aria-label="按钮">
