    ...
    <div v-if="show" class="modal-overlay" @click.self="$emit('close')">
      <div class="permissions-modal">
        <dialog class="modal-header">
          ...
          <button type="button" class="close-button" @click="$emit('close')" aria-label="按钮">
            <X :size="20" />
          </button>
        </div>
        ...
        <dialog class="modal-actions">
          <button type="button" class="btn btn-secondary" @click="$emit('close')" aria-label="按钮">Cancel</button>
          <button
            type="button"
