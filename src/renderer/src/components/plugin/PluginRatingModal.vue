          ...
          <form @submit.prevent="submitRating" class="rating-form">
            ...
            <div class="options-section">
              <label class="option-item">
                <input id="input-0ens1jvhr" v-model="isAnonymous" type="checkbox" class="option-checkbox"  aria-label="输入框">
            ...
            <dialog class="modal-actions">
              <button type="button" @click="$emit('close')" class="action-btn cancel" aria-label="按钮">取消</button>
              <button
                type="submit"
