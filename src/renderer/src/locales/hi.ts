...
export default {
  ...
  chat: {
    ...
    welcomeMessage: 'आपका बुद्धिमान AI सहायक, प्रश्नों का उत्तर देने, कोड लिखने, टेक्स्ट अनुवाद आदि के लिए तैयार है',
    ...
    deleteConfirmMessage: 'इस चैट में {count} संदेश हैं। हटाने के बाद इसे पुनर्स्थापित नहीं किया जा सकता।',
    clearConfirm: 'क्या आप इस बातचीत को साफ़ करना चाहते हैं? इसे पूर्ववत नहीं किया जा सकता।',
    newChatConfirm: 'नई बातचीत शुरू करें',
    newChatConfirmMessage: 'आपके इनपुट बॉक्स में अनभेजी सामग्री है। नई बातचीत शुरू करने से यह सामग्री साफ़ हो जाएगी। जारी रखें?'
  },
